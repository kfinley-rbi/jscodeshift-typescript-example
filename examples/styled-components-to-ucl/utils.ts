...
const removeProps = [/^animation/, /^display/];

const unsupportedProps = [/^objectFit$/, /^animation/];

const unsupportedValue = [/^calc/, /^relative$/];

const _isUnsupported = (test, regex) => _.some(re => re.test(test), regex);
